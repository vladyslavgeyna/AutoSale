        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WheelDrive = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Text = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UserIdFrom = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    UserIdTo = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserReviews", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserReviews_AspNetUsers_UserIdFrom",
                        column: x => x.UserIdFrom,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserReviews_AspNetUsers_UserIdTo",
                        column: x => x.UserIdTo,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarComparisons", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CarComparisons_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CarComparisons_CarAds_CarAdId",
                        column: x => x.CarAdId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarComparisons_CarAdId",
                table: "CarComparisons",
                column: "CarAdId");

            migrationBuilder.CreateIndex(
                name: "IX_CarComparisons_UserId",
                table: "CarComparisons",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserReviews_UserIdFrom",
                table: "UserReviews",
                column: "UserIdFrom");

            migrationBuilder.CreateIndex(
                name: "IX_UserReviews_UserIdTo",
                table: "UserReviews",
                column: "UserIdTo");
        }
